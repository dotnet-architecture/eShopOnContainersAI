...
namespace eShopOnContainers.iOS {
	...
	/// </summary>
	public class customvisionInput : NSObject, IMLFeatureProvider
	{
	...
	/// </summary>
	public class customvisionOutput : NSObject, IMLFeatureProvider
	{
		static readonly NSSet<NSString> featureNames = new NSSet<NSString> (
		...
		public customvisionOutput (NSDictionary<NSObject, NSNumber> loss, string classLabel)
		{
			if (loss == null)
	...
	/// </summary>
	public class customvision : NSObject
	{
		...
		customvision (MLModel model)
		{
			this.model = model;
		}

		public static customvision Create (NSUrl url, out NSError error)
		{
			if (url == null)
			...
			return new customvision (model);
		}

		/// <summary>
		/// Make a prediction using the standard interface
		/// </summary>
		/// <param name="input">an instance of customvisionInput to predict from</param>
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public customvisionOutput GetPrediction (customvisionInput input, out NSError error)
		{
			...
			return new customvisionOutput (lossValue, classLabelValue);
		}
		...
		/// <param name="error">If an error occurs, upon return contains an NSError object that describes the problem.</param>
		public customvisionOutput GetPrediction (CVPixelBuffer data, out NSError error)
		{
			var input = new customvisionInput (data);
