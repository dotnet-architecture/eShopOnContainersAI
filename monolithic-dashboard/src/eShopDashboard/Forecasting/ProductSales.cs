...
namespace eShopDashboard.Forecasting
{
    ...
    public class ProductSales : IProductSales
    {
        ...
        /// </summary>
        private PredictionEngine<ProductData, ProductUnitPrediction> CreatePredictionEngine(IHostEnvironment env, string modelPath)
        {
            using (var fs = File.OpenRead(modelPath))
                return env.CreatePredictionEngine<ProductData, ProductUnitPrediction>(fs);
        }
    }
}
